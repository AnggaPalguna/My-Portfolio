...
const Footer = () => {
  ...
  return (
    ...
    <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
        ...
        <li>
        <IoLogoGithub  href="#" className="h-10 w-10 hover:text-black dark:hover:text-white me-4 md:me-6" />
        </li>
        <li>
        <FaLinkedin  href="#" className="h-10 w-10 hover:text-black dark:hover:text-white me-4 md:me-6" />
        </li>
    </ul>
    </div>
</footer>
